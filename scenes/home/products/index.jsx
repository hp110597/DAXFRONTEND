...
const PRODUCTS = [{
  ...
  name: "COLD CUP 1",
  infor: [['The fashionable cup designed by one of the most creative creator Khim', 'Dang, The fashionable cup designed by one of the most creative creator', 'Khim Dang, The fashionable cup designed by one of the most creative', 'creator Khim Dang.'], ['+ Dung tích 500ml', '+ 30cmx17cm', '+ Chất liệu: nhôm nguyên khối']]
},
{
  id: "PD002",
...
const Products = (props) => {
  ...
  const productList = useMemo(() => {
    return PRODUCTS.map((product, index) => {
      return <ProductItem key={index} product={product} onShowDialog={props.onShowDialog}
        productActive={indexActive === index ? true : false}
        prevProductActive={prevIndexActive.current === index ? true : false} index={index} />
    })
  }, [PRODUCTS, indexActive, prevIndexActive, props.onShowDialog])


  return (
    <div className="h-screen bg-[#000000] relative overflow-hidden snap-start">
      {productList}
